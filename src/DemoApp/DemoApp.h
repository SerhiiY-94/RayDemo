...
class DemoApp {
    ...
    bool            nogpu_, coherent_, copy_lib_;
    ...
    void LoadLib(int w, int h, const char *scene_name, bool nogpu, bool coherent, bool copy_lib);
public:
    DemoApp();
    ~DemoApp();

    int Init(int w, int h, const char *scene_name, bool nogpu, bool coherent, bool copy_lib);
    void Destroy();
